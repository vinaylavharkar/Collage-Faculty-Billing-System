...
// Page header
      function Header()
      {
          ...
          // Arial bold 15
          if($this->PageNo()==1){
          $this->Image('../../../img/dtelogo.jpg',92,12,22,22);
          $this->SetFont('times new roman','B',10);
          $this->cell(189,24,"",0,1,'C');
          $this->cell(189,6,"GOVERNMENT POLYTECHNIC AHMEDNAGAR",0,1,'C');
          $this->cell(189,6,"BILL OF REMUNERATION FOR C.H.B. LECTURERS",0,1,'C');
          $this->cell(9,6,"",0,1);
          $this->cell(9,6,"",0,0);
        
          $this->cell(61,6,"Name of Visiting Lecturer",1,0);
          $this->cell(110,6,$this->name,1,0);
          $this->cell(9,6,"",0,1);
          $this->cell(9,6,"",0,0);
          $this->cell(61,6,"Department/Branch",1,0);
          $this->cell(110,6,"CO/CM",1,0);
          $this->cell(9,6,"",0,1);
          $this->cell(9,6,"",0,0);
          $this->cell(61,6,"Bill for the month",1,0);
          $this->cell(110,6,$this->month,1,0);
          $this->cell(9,6,"",0,1);
          $this->cell(9,6,"",0,0);
          $this->cell(61,6,"Date of Submission",1,0);
          $this->cell(110,6,$this->Date,1,0);
          $this->cell(9,6,"",0,1);
          $this->cell(9,6,"",0,1);
...
while($row=$result1->fetch_assoc())
    {
     ...
     if($as<$h)
     {
      $pdf->SetFont('times new roman','B',8);
       $pdf->cell(189,6,"Continued on next page......   ",0,1,"R");
       $pdf->AddPage();
      
       $pdf->cell(9,10,"Sr NO",1,0,'C');
       $pdf->cell(25,10,"Date",1,0,'C');
       $pdf->cell(10,10,"Class",1,0,'C');
       $pdf->cell(26,5,"Time",1,0,'C');
       $pdf->cell(9,10,"Hours",1,0,'C');
       $pdf->cell(8,5,"TH","LTR",0,'C');
       $pdf->cell(13,10,"Subject",1,0,'C');
       $pdf->cell(13,5,"Present","LTR",0,'C');
       $pdf->cell(76,10,"Topic covered in brief",1,0,'C');
       $pdf->cell(0,5,"",0,1);
       $pdf->cell(9,5,"",0,0,'C');
       $pdf->cell(25,5,"",0,0,'C');
       $pdf->cell(10,5,"",0,0,'C');
       $pdf->cell(13,5,"From",1,0,'C');
       $pdf->cell(13,5,"To",1,0,'C');
       $pdf->cell(9,5,"",0,0,'C');
       $pdf->cell(8,5,"/PR","LRB",0,'C');
       $pdf->cell(13,5,"",0,0,'C');
       $pdf->cell(13,5,"Student","LRB",0,'C');
       $pdf->cell(76,5,"",0,0,'C');
       $pdf->cell(0,5,"",0,1);
           if($pdf->PageNo()>=2)
      {
...
$count++;
    ...
    $pdf->cell(189,6," Declaration :- I declare that the above information is true and correct to the best of my knowledge and belief and that I have not claimed this bill before.",0,1,'c');
    $pdf->cell(0,6,"",0,1);
    $as=$as-12; 
    if($as<34)
    {
      $pdf->Addpage(); 
      $as=264;
    $pdf->cell(62,6,"SUMMARY OF BILL",1,0,'C');
     $pdf->cell(8,6,"",0,0);
     $pdf->cell(119,6,"CERTIFICATE",1,1,"C");
    
     $pdf->cell(13,5,"Type","LTR",0,'C');
     $pdf->cell(12,5,"Hours ","LTR",0,'C');
     $pdf->cell(12,5,"Rate Per","LTR",0,'C');
     $pdf->cell(25,5,"Amount Rs.","LTR",0,'C');
     $pdf->cell(8,5,"",0,0);
     $pdf->SetFont('times new roman','',8);
     $pdf->SetFont('times new roman','B',8);
     $pdf->cell(119,5,"The bill may be passed for Rs.".$total,"LTR",0);
    
    
     $pdf->cell(13,5,"",0,0);
     $pdf->cell(119,5,"The bill may be passed for Rs.".$total,1,0);
    
     $pdf->cell(0,5,"",0,1);
     $pdf->SetFont('times new roman','B',8);
     $pdf->cell(13,5,"","LRB",0,'C');
     $pdf->cell(12,5,"Thought","LRB",0,'C');
     $pdf->cell(12,5,"Hour Rs.","LRB",0,'C');
     $pdf->cell(25,5,"","LRB",0,'C');
     $pdf->cell(8,5,"",0,0);
     $pdf->cell(119,5,"( In Words ) ".$word,"LRB",0);
     $pdf->cell(0,5,"",0,1);
     $pdf->SetFont('times new roman','B',8);
     $pdf->cell(13,6,"Theory",1,0,'C');
     $pdf->SetFont('times new roman','',8);
     $pdf->cell(12,6,$thhours,1,0,'C');
     $pdf->cell(12,6,$Th_rate,1,0,'C');
     $pdf->cell(25,6, $thamount,1,0,'C');
     $pdf->cell(8,5,"",0,0);   
     $pdf->cell(39,6,"","LTR",0);
     $pdf->cell(40,6,"","LTR",0);
     $pdf->cell(40,6,"","LTR",1);
     ...
     $pdf->SetFont('times new roman','B',8);
     $pdf->cell(13,6,"Practical",1,0,'C');
     $pdf->SetFont('times new roman','',8);
     $pdf->cell(12,6,$prhours,1,0,'C');
     $pdf->cell(12,6,$Pr_rate,1,0,'C');
     $pdf->cell(25,6,$pramount,1,0,'C');
     $pdf->cell(8,6,"",0,0);
     $pdf->cell(39,6,"","LR",0);
     $pdf->cell(40,6,"","LR",0);
     $pdf->cell(40,6,"","LR",0);
     ...
     $pdf->SetFont('times new roman','B',8);
     $pdf->cell(37,6,"Total Amount",1,0,'C');
     $pdf->SetFont('times new roman','',8);
    //  $pdf->cell(9,6,"",1,0,'C');
    //  $pdf->cell(10,6,"",1,0,'C');
     ...
     $pdf->SetFont('times new roman','B',8);
     $pdf->cell(39,6,"Checked By","LRB",0,"C");
     $pdf->cell(40,6,"Verified By","LRB",0,"C");
     $pdf->cell(40,6,"Head of Department","LRB",1,"C");
     $as=$as-34;
    ...
    $pdf->cell(0,8,"",0,1); 
     $pdf->cell(9,6,"",0,0); 
     $pdf->cell(180,6,"Signature:-",0,1); 
     $pdf->cell(9,6,"",0,0); 
     $pdf->cell(180,6,"Name:-         ".$Full_name,0,1); 
     $pdf->cell(9,6,"",0,0); 
     $pdf->cell(180,6,"Mob No:-     ".$Mn,0,1); 
     $as=$as-26;
    }
    else
    {
    ...
    if($as<12)
    {
      ...
      $pdf->cell(0,6,"",0,1);
      $pdf->cell(155,6,"",0,0);
      $pdf->cell(20,6,"Registrar",0,1,"C");
      $pdf->cell(189,6,"Government Polytechnic, Ahmednagar",0,1,"R");
      $as=$as-12;
    ...
    if($as<12)
    {
      ...
      $pdf->cell(0,6,"",0,1);
      $pdf->cell(9,6,"",0,0); 
      $pdf->cell(180,6,"Bill Passed for Payment Rs. ".$total,0,1); 
      $pdf->cell(9,6,"",0,0);
      $pdf->cell(180,6,"In Words".$word,0,1); 
      $as=$as-12;
    ...
    if($as<20)
    {
      ...
      $as=264;
      $pdf->cell(0,8,"",0,1);
      $pdf->cell(189,6,"Principal",0,1,"C"); 
      $pdf->cell(189,6,"Government Polytechnic, Ahmednagar",0,1,"C"); 
      $as=$as-20;
