...
while($row=$result1->fetch_assoc())
    {
     ...
     $pdf->SetFont('times new roman','',8);
      ...
      $pdf->cell(9,6,$count,1,0,'C');
      $pdf->cell(25,6,$Date,1,0,'C');
      $pdf->cell(10,6,$Class,1,0,'C');
      $pdf->cell(13,6,$Time_from,1,0,'C');
      $pdf->cell(13,6,$Time_to,1,0,'C');
      $pdf->cell(9,6,$Hours,1,0,'C');
      $pdf->cell(8,6,$THPR,1,0,'C');
      $pdf->cell(13,6,$Subject,1,0,'C');
      $pdf->cell(13,6,$Present_Student,1,0,'C');
      $pdf->cell(76,6,$Topic_covered,1,0,'C');
      $pdf->cell(0,6,"",0,1);
$count++;
    }
