        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              <div class="container">
                <form action="./php/Billsubmit.php" method="POST">
...
<div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center table-bordered mb-0">
                  ...
                  <tr>
                    ...
                    <th colspan='3' class="text-center text-uppercase text-xs  font-weight-bolder "><?php echo $_SESSION["Month"]?></th>
                    </tr> 
                    <tr>
                    <th colspan='3' class="text-center text-uppercase text-xs  font-weight-bolder ">Date of submission:</th>
                    <th colspan='2' class="text-center text-uppercase text-xs  font-weight-bolder "></th>
                    </tr> 
      ...
      <div class='row justify-content-center'>
                  ...
                  <input type='submit' name="submit" value='submit' class='btn btn-success w-25'>
                </div>
