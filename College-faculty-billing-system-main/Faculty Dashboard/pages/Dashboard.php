            ...
            <div class="card-body px-0 pb-2">
              <div class="container">
                ...
                <div class="form-group m-md-3">
                  <h2 class="text-center " style="color:#e41bd5;">Hi <?php echo $_SESSION["name"]; ?></h2> 
                  <h2 class="text-center " style="color:#591ee9;">Welcome to Goverment Polytechnic Ahmednagar</h2> 
              ...
              <div class="col-12 d-flex justify-content-center " >
                    <img src="../../img/dtelogo.jpg" style="widht:10em; height:10em;">
