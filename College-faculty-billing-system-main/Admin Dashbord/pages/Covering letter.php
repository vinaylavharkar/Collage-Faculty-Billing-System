...
<span class="nav-link-text ms-1">Assign Timetable</span>
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary  " href="../pages/Covering letter.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Covering Letter</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Covering Letter</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Covering Letter</h6>
              </div>
            </div>
        
              <form action='./php/Covering letter.php' method='POST'>
                  <div class='row'>
                  ...
                  <input type='submit' value='submit' name="submit"class='btn btn-success w-25'>
                </div>
                  </div>
                  </form>
