...
include ('./php/pretitabledetails.php');
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark ps bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary " href="../pages/Assign Timetable.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
</div>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Assign Timetable</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Assign Timetable</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Assign Timetable</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="container">
                <form action="./php/facultytimetabledetails.php" id="form1" method="POST">
                <div class="row">
                  <div class="col-md-4">
                    <label for="">Faculty Name : <?php echo $_SESSION["name"];?></label>
                  </div>
                  <div class="col-md-4 ms-auto">
                    <label for="">Faculty ID : <?php echo $_SESSION["Faculty_id"];?></label>
                  </div>
</div>
<div class="card-body px-0 pb-2">
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Room No/Lab Name</th>
             ...
             if($result->num_rows > 0)
             {
               ...
               while($row=$result->fetch_assoc())
               {
                ...
                <span class='text-secondary text-xs font-weight-bold'id='r".$count."s1' >$Days</span>
                </td>

                <td class='align-middle text-center text-sm'>
                <span class='text-secondary text-xs font-weight-bold'id='r".$count."s2'>$Time_from</span>
                </td>
                <td class='align-middle text-center'>
                <span class='text-secondary text-xs font-weight-bold'id='r".$count."s3'>$Time_to</span>
                </td>
                <td class='align-middle text-center'>
                <span class='text-secondary text-xs font-weight-bold'id='r".$count."s4'>$Scheme</span>
                </td>
                <td class='align-middle text-center'>
                <span class='text-secondary text-xs font-weight-bold'id='r".$count."s5'>$Class</span>
                </td>
                <td class='align-middle text-center'>
                <span class='text-secondary text-xs font-weight-bold'id='r".$count."s6'>$Sem</span>
                </td>
                <td class='align-middle text-center'>
                <span class='text-secondary text-xs font-weight-bold'id='r".$count."s7'>$Subject</span>
                </td>
                <td class='align-middle text-center'>
                <span class='text-secondary text-xs font-weight-bold'id='r".$count."s8'>$THPR</span>
                </td>
                <td class='align-middle text-center'>
                <span class='text-secondary text-xs font-weight-bold'id='r".$count."s9'>$Batch</span>
                </td>
                <td class='align-middle text-center'>
                <span class='text-secondary text-xs font-weight-bold'id='r".$count."s10'>$rnln</span>
                </td>
                <td class='align-middle'>
              <input type='button' class='btn btn-secondary btn-sm' onclick='editsub(this)' value='Edit'id='r".$count."btn1' >
             </td>
             <td class='align-middle'>
             <input type='button'id='r".$count."btn2' onclick='del(this)'  name='delete' class='btn btn-danger btn-sm' value='Delete'>
             </td>
              </tr>";
              $count++;
               }
...
<input type="button" onclick="addsub()"id="addtimetablebtn" disable="false"class="btn btn-warning m-1 btn-sm" value="Add Timetable row">
...
<?php
             ...
             $result=$con->query($q);
             if($result->num_rows > 0){
                 echo"<script>addnoti()</script>";
             }
             else
             {
              echo"<script>remnoti()</script>";
             }
             ?>
