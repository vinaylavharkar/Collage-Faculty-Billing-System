  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark ps bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../pages/Add new faculty.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Add New Faculty</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Add New Faculty</h6>
        </nav>
        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              <div class="container">
                <form action="php/add new faculty.php" method="POST">
                <div class="row">
                  <div class="col-lg-4">
              ...
              <div class="col-lg-4">
                <div class="form-group m-md-3">
                  ...
                  <input type="text" name="Middle_name" required="required" class="form-control">
                </div>
              </div>
              <div class="col-lg-4">
                <div class="form-group m-md-3">
              ...
              <div class="row justify-content-center">
               ...
               <input type="submit" name="submit" class="btn btn-success w-25" value="add">   
