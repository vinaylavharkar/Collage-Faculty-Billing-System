...
<span class="nav-link-text ms-1">Assign Timetable</span>
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../pages/Set scheme.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Set Scheme</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Set Scheme</h6>
        </nav>
        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Set Scheme</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="container">
                <form action="php/Set Scheme.php" method="POST">
                <div class="row">
                  <div class="col-lg-4">
                <div class="form-group m-md-3">
                  <label for="">Scheme_name </label>
                  <input type="text" name="Scheme_name" required="required" class="form-control">
                </div>
              </div>
              </div>
              <div class="row">
                <div class="col-12">
                <label for=""><b>Subjects </b></label>
                </div>
              </div>
              ...
              <div class="row mb-4">
                <div class="col m-md-2 ">
                  <div class="form-group">
                    ...
                    <input type= "text"  name="Subject1" required="required" class="form-control">
                  </div>
                </div>
                <div class="col-md-4">
           <div class="form-group m-md-2">
             <label for="">Semester </label>
             <select required class="form-select" id="Semester1" name="Semester1" >
          ...
          <div class="col-md-4">
           <div class="form-group m-md-2">
             ...
             <select required class="form-select" id="TH/PR1" name="TH/PR1" >
...
<input type="button" onclick="addrow()" class="btn btn-warning m-1" value="add">
             <input type="button" onclick="delrow()" class="btn btn-danger m-1" value="remove">
            </div>
          </div>
