    ...
    while($result->num_rows > 0)
     {
        ...
        $result=$con->query($q1);
           ...
           {
            $stmt=$con->prepare("INSERT INTO `faculty_login` (`Faculty_id`, `First_name`, `Middle_name`, `Last_name`, `Email`,  `Status`) VALUES (?,?,?,?,?,?)");
            $stmt->bind_param("ssssss",$Faculty_id,$First_name,$Middle_name,$Last_name,$Email,$Status); 
